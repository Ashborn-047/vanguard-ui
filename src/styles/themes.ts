...
export const themes: Record<string, Theme> = {
  minimalism: {
    ...
    secondaryButton: "bg-white border border-gray-200 text-gray-900 rounded-md hover:bg-gray-50 transition-colors",
    input: "bg-white border border-gray-200 rounded-md focus:ring-1 focus:ring-black focus:border-black transition-all",
    ...
    footer: "bg-white border-t border-gray-200 text-gray-600",
  ...
  neoBrutalism: {
    ...
    popover: "bg-white border-2 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none",
    ...
    secondaryButton: "bg-white text-black font-bold border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] rounded-none",
    input: "bg-white border-2 border-black p-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] focus:translate-x-[2px] focus:translate-y-[2px] focus:outline-none transition-all rounded-none font-bold",
    ...
    tabInactive: "bg-white border-2 border-black text-gray-500 hover:bg-gray-50",
  ...
  claymorphism: {
    ...
    card: "bg-white rounded-3xl p-6 shadow-[10px_10px_20px_rgba(174,174,192,0.4),-10px_-10px_20px_#FFFFFF] border-none",
    popover: "bg-white rounded-3xl p-6 shadow-[20px_20px_40px_rgba(174,174,192,0.4),-20px_-20px_40px_#FFFFFF] border-none",
